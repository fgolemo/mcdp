...
def check_connect2_a():
    ...
    res = connect2(ndp1, ndp2, connections, split=set())

    assert res.get_fnames() == ['f2']
    assert res.get_rnames() == ['R0']
...
def check_connect2_b():
    ...
    assert res.get_fnames() == ['f1', 'f2']
    assert res.get_rnames() == ['r1', 'R0']
...
def check_connect2_c():
    ...
    assert res.get_fnames() == ['f1', 'f2']
    assert res.get_rnames() == ['r1', 'r3', 'R0']
