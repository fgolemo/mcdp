...
setup(name='PyMCDP',
      ...
      dependency_links  = [
          'https://github.com/AndreaCensi/contracts/archive/env_fault.zip',
          'https://github.com/AndreaCensi/conf_tools/archive/env_fault.zip',
          'https://github.com/AndreaCensi/quickapp/archive/env_fault.zip',
          'https://github.com/AndreaCensi/reprep/archive/env_fault.zip',
          'https://github.com/AndreaCensi/gvgen/archive/master.zip',
      ],
